...
{
public:
  static bool intersectRayAndPlane(const Vector3f& point, const Vector3f& v, const Vector3f& plane, const Vector3f& n, Vector3f& intersection);
  static bool intersectRayAndBox(
  ...
  static void transformRayToObjectAtOrigin(
  ...
  static bool intersectRayWithAxisAlignedPlane(const Vector3f& p, const Vector3f& v, float distance, int thirdAxis, float maxAbsAxis1, float maxAbsAxis2, Vector3f& intersectionPos);

  static Pose3f calculateFootPos(const JointAngles& jointAngles, const Joints::Joint& joint, const RobotDimensions& robotDimensions);

  static Pose3f calculateHandPos(const JointAngles& jointAngles, const Joints::Joint& joint, const RobotDimensions& robotDimensions);

  static Vector3f calcFootPos(
