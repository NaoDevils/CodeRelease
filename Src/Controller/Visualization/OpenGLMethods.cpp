...
void OpenGLMethods::paintCubeToOpenGLList(
    int xLow, int yLow, int zLow, int xHigh, int yHigh, int zHigh, int listID, bool paintFullCube, int scale, int offsetX, int offsetY, int offsetZ, int r, int g, int b, bool beginList, bool endList)
{
...
void OpenGLMethods::paintImagePixelsToOpenGLList(const Image& image, int colorModel, int zComponent, bool polygons, int listID, int x1, int x2, int y1, int y2)
{
  // Build a new list
  ::glNewList(listID, GL_COMPILE_AND_EXECUTE);
