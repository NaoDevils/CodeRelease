...
public:
  ...
  template <typename U> void predict(const U& u, double dt)
  {
  ...
  template <typename M, typename Derived> void update(const M& z, const Eigen::MatrixBase<Derived>& R)
  {
