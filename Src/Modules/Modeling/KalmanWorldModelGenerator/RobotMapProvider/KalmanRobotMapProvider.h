...
private:
   ...
   */
  void sensorUpdateSingle(const Vector2f& position, float distanceToRobot, RobotEstimate::RobotType robotType, unsigned timeStamp, float perceptValidity, int playerNumber);
