/**
*
* This file contains parameters for the SelfLocator2012.
*
...
STREAMABLE(SelfLocator2012Parameters,
{
  ...
  (float) sensorUpdate_influenceOfNewMeasurementOnSymmetryConfidence, // [0..1]
  ...
  (bool) updateSymmetryWithRemoteModels,
