#include "ControllerParams2012Provider.h"
#include "Tools/Settings.h"
#include "Platform/File.h"
#include <cstdlib>
ControllerParams2012Provider::ControllerParams2012Provider()
{
  load();
}

void ControllerParams2012Provider::update(ControllerParams& controllerParams)
{
  controllerParams = contParams;
}


int ControllerParams2012Provider::load()
{
  FILE *stream;
...
MAKE_MODULE(ControllerParams2012Provider, dortmundWalkingEngine) 
