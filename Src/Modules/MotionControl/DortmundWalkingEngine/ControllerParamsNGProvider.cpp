#include "ControllerParamsNGProvider.h"
#include "Tools/Settings.h"
#include "Platform/File.h"
#include <cstdlib>

ControllerParamsNGProvider::ControllerParamsNGProvider()
{
  load();
}

void ControllerParamsNGProvider::update(ControllerParams& controllerParams)
{
  controllerParams = contParams;
}


int ControllerParamsNGProvider::load()
{
  FILE *stream;
...
MAKE_MODULE(ControllerParamsNGProvider, dortmundWalkingEngine) 
