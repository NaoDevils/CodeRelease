/**
  * YoloBallDetector to detect balls in complete images
**/
...
{ ,
  ...
  USES(BallModel),
  PROVIDES(BallHypothesesYoloUpper),
  LOADS_PARAMETERS(
  { ,
    ...
    (float)(4500.f) maxDetectionDistance,
  }),
});
...
public:
  ...
  void update(BallHypothesesYoloUpper& theBallHypothesesYoloUpper);
...
private:
  ...
  BallHypothesesYoloUpper localBallHypothesesUpper;
