...
void CameraMatrixProvider::update(CameraMatrix& cameraMatrix)
{
  ...
  DEBUG_DRAWING("module:CameraMatrixProvider:calibrationHelper", "drawingOnImage") drawFieldLines(cameraMatrix, false);
...
void CameraMatrixProvider::update(CameraMatrixUpper& cameraMatrix)
{
  ...
  DEBUG_DRAWING("module:CameraMatrixProvider:calibrationHelperUpper", "drawingOnImage") drawFieldLines(cameraMatrix, true);
...
void CameraMatrixProvider::drawFieldLines(const CameraMatrix& cameraMatrix, bool upper) const
{
  ...
  for (unsigned int i = 0; i < theFieldDimensions.fieldLines.lines.size(); ++i)
  {
    ...
    if (upper)
    {
      LINE("module:CameraMatrixProvider:calibrationHelperUpper", start0I.x(), start0I.y(), end0I.x(), end0I.y(), 0, Drawings::solidPen, ColorRGBA(0, 0, 0));
      LINE("module:CameraMatrixProvider:calibrationHelperUpper", start1I.x(), start1I.y(), end1I.x(), end1I.y(), 0, Drawings::solidPen, ColorRGBA(0, 0, 0));
    }
    else
    {
      LINE("module:CameraMatrixProvider:calibrationHelper", start0I.x(), start0I.y(), end0I.x(), end0I.y(), 0, Drawings::solidPen, ColorRGBA(0, 0, 0));
      LINE("module:CameraMatrixProvider:calibrationHelper", start1I.x(), start1I.y(), end1I.x(), end1I.y(), 0, Drawings::solidPen, ColorRGBA(0, 0, 0));
    }
  }
  ...
  if (upper)
    LINE("module:CameraMatrixProvider:calibrationHelperUpper", start0I.x(), start0I.y(), end0I.x(), end0I.y(), 0, Drawings::solidPen, ColorRGBA::blue);
  else
