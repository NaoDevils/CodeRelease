...
void PositioningSymbols::draw() const
{
  ...
  DEBUG_DRAWING("representation:PositioningSymbols", "drawingOnField")
  {
    ...
    ELLIPSE("representation:PositioningSymbols", optPosition.translation,
      (thresholdXBack + thresholdXFront) / 2, thresholdY, optPosition.rotation, 5, Drawings::solidPen, ColorRGBA::blue, Drawings::noBrush, ColorRGBA::blue);
