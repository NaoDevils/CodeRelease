 ...
 */
#define DEBUG_DRAWING(id, type) if (Global::getDrawingManager().addDrawingId(id, type), _debugRequestActive("debug drawing:" id))
 ...
 * @param id A drawing id
 */
#define COMPLEX_DRAWING(id) DECLARED_DEBUG_RESPONSE("debug drawing:" id)
...
#define CIRCLE(id, center_x, center_y, radius, penWidth, penStyle, penColor, brushStyle, brushColor)                                                              \
  do                                                                                                                                                              \
    ...
    {                                                                                                                                                             \
      OUTPUT(idDebugDrawing,                                                                                                                                      \
          bin,                                                                                                                                                    \
          (char)Drawings::circle << (char)Global::getDrawingManager().getDrawingId(id) << (int)(center_x) << (int)(center_y) << (int)(radius) << (char)(penWidth) \
...
#define ARC(id, center_x, center_y, radius, startAngle, spanAngle, penWidth, penStyle, penColor, brushStyle, brushColor)                                                                 \
  do                                                                                                                                                                                     \
    ...
    {                                                                                                                                                                                    \
      OUTPUT(idDebugDrawing,                                                                                                                                                             \
          bin,                                                                                                                                                                           \
          (char)Drawings::arc << (char)Global::getDrawingManager().getDrawingId(id) << (int)(center_x) << (int)(center_y) << (int)(radius) << int(toDegrees(startAngle) * 16.f + 0.5f)   \
                              << int(toDegrees(spanAngle) * 16.f + 0.5f) << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor) << (char)(brushStyle) << ColorRGBA(brushColor)); \
    }                                                                                                                                                                                    \
  while (false)
...
#define ELLIPSE(id, center, radiusX, radiusY, rotation, penWidth, penStyle, penColor, brushStyle, brushColor)                                                          \
  do                                                                                                                                                                   \
    ...
    {                                                                                                                                                                  \
      OUTPUT(idDebugDrawing,                                                                                                                                           \
          bin,                                                                                                                                                         \
          (char)Drawings::ellipse << (char)Global::getDrawingManager().getDrawingId(id) << (int)(center.x()) << (int)(center.y()) << (int)(radiusX) << (int)(radiusY)  \
                                  << (float)(rotation) << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor) << (char)(brushStyle) << ColorRGBA(brushColor)); \
    }                                                                                                                                                                  \
  while (false)
...
#define RECTANGLE2(id, topLeft, width, height, rotation, penWidth, penStyle, penColor, brushStyle, brushColor)                                                         \
  do                                                                                                                                                                   \
    ...
    {                                                                                                                                                                  \
      OUTPUT(idDebugDrawing,                                                                                                                                           \
          bin,                                                                                                                                                         \
          (char)Drawings::rectangle << (char)Global::getDrawingManager().getDrawingId(id) << (int)(topLeft.x()) << (int)(topLeft.y()) << (int)(width) << (int)(height) \
                                    << (float)rotation << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor) << (char)(brushStyle) << ColorRGBA(brushColor)); \
    }                                                                                                                                                                  \
  while (false)
...
#define POLYGON(id, numberOfPoints, points, penWidth, penStyle, penColor, brushStyle, brushColor)                                                              \
  do                                                                                                                                                           \
    ...
    {                                                                                                                                                          \
      ...
      OUTPUT(idDebugDrawing,                                                                                                                                   \
          bin,                                                                                                                                                 \
          (char)Drawings::polygon << (char)Global::getDrawingManager().getDrawingId(id) << (int)numberOfPoints << _buf << (char)(penWidth) << (char)(penStyle) \
                                  << ColorRGBA(penColor) << (char)(brushStyle) << ColorRGBA(brushColor));                                                      \
      delete[] _buf;                                                                                                                                           \
    }                                                                                                                                                          \
  while (false)

/**
  * A macro that sends a pointcloud
  * @param id A drawing id (Drawings::FieldDrawing or Drawings::ImageDrawing)
  * @param numberOfPoints The number the points of the pointcloud
  * @param points A list which contains the points of the pointcloud
  * @param radius The radius of the circle
  * @param penWidth The width of the pen
  * @param penStyle The pen style of the arc of the circle (Drawings::PenStyle)
  * @param penColor The color of the arc of the circle
  ...
  * @param brushColor The brush color of the polygon
  */
#define POINTCLOUD(id, numberOfPoints, points, radius, penWidth, penStyle, penColor, brushStyle, brushColor)      \
  do                                                                                                              \
    COMPLEX_DRAWING(id)                                                                                           \
    {                                                                                                             \
      for (int _i = 0; _i < numberOfPoints; ++_i)                                                                 \
        CIRCLE(id, points[_i].x(), points[_i].y(), radius, penWidth, penStyle, penColor, brushStyle, brushColor); \
    }                                                                                                             \
  while (false)
  ...
  do                                                                                                                                                                                          \
    ...
    {                                                                                                                                                                                         \
      ...
      for (int _i = 0; _i < (cellsX * cellsY); ++_i)                                                                                                                                          \
        _stream << cells[_i];                                                                                                                                                                 \
      _buf[_size.getSize()] = 0;                                                                                                                                                              \
      OUTPUT(idDebugDrawing, bin, (char)Drawings::gridRGBA << (char)Global::getDrawingManager().getDrawingId(id) << int(x) << int(y) << int(cellSize) << int(cellsX) << int(cellsY) << _buf); \
      delete[] _buf;                                                                                                                                                                          \
    }                                                                                                                                                                                         \
  while (false)
...
#define GRID_MONO(id, x, y, cellSize, cellsX, cellsY, baseColor, cells)                                                                                                                       \
  do                                                                                                                                                                                          \
    ...
    {                                                                                                                                                                                         \
      ...
      OUTPUT(idDebugDrawing,                                                                                                                                                                  \
          bin,                                                                                                                                                                                \
          (char)Drawings::gridMono << (char)Global::getDrawingManager().getDrawingId(id) << int(x) << int(y) << int(cellSize) << int(cellsX) << int(cellsY) << ColorRGBA(baseColor) << _buf); \
      delete[] _buf;                                                                                                                                                                          \
    }                                                                                                                                                                                         \
  while (false)
...
#define DOT(id, x, y, penColor, brushColor)                                                                                                                                           \
  do                                                                                                                                                                                  \
    DECLARED_DEBUG_RESPONSE("debug drawing:" id)                                                                                                                                      \
    {                                                                                                                                                                                 \
      OUTPUT(idDebugDrawing, bin, (char)Drawings::dot << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x) << (int)(y) << ColorRGBA(penColor) << ColorRGBA(brushColor)); \
    }                                                                                                                                                                                 \
  while (false)
...
#define DOT_AS_VECTOR(id, xy, penColor, brushColor)                                                                                                                                             \
  do                                                                                                                                                                                            \
    DECLARED_DEBUG_RESPONSE("debug drawing:" id)                                                                                                                                                \
    {                                                                                                                                                                                           \
      OUTPUT(idDebugDrawing, bin, (char)Drawings::dot << (char)Global::getDrawingManager().getDrawingId(id) << (int)(xy.x()) << (int)(xy.y()) << ColorRGBA(penColor) << ColorRGBA(brushColor)); \
    }                                                                                                                                                                                           \
  while (false)
...
#define MID_DOT(id, x, y, penColor, brushColor)                                                                                                                                          \
  do                                                                                                                                                                                     \
    DECLARED_DEBUG_RESPONSE("debug drawing:" id)                                                                                                                                         \
    {                                                                                                                                                                                    \
      OUTPUT(idDebugDrawing, bin, (char)Drawings::midDot << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x) << (int)(y) << ColorRGBA(penColor) << ColorRGBA(brushColor)); \
    }                                                                                                                                                                                    \
  while (false)
...
#define LARGE_DOT(id, x, y, penColor, brushColor)                                                                                                                                          \
  do                                                                                                                                                                                       \
    DECLARED_DEBUG_RESPONSE("debug drawing:" id)                                                                                                                                           \
    {                                                                                                                                                                                      \
      OUTPUT(idDebugDrawing, bin, (char)Drawings::largeDot << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x) << (int)(y) << ColorRGBA(penColor) << ColorRGBA(brushColor)); \
    }                                                                                                                                                                                      \
  while (false)
...
#define LINE(id, x1, y1, x2, y2, penWidth, penStyle, penColor)                                                                                                                                            \
  do                                                                                                                                                                                                      \
    ...
    {                                                                                                                                                                                                     \
      OUTPUT(idDebugDrawing,                                                                                                                                                                              \
          bin,                                                                                                                                                                                            \
          (char)Drawings::line << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x1) << (int)(y1) << (int)(x2) << (int)(y2) << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor)); \
    }                                                                                                                                                                                                     \
  while (false)
...
#define ARROW(id, x1, y1, x2, y2, penWidth, penStyle, penColor)                                                                                                                                            \
  do                                                                                                                                                                                                       \
    ...
    {                                                                                                                                                                                                      \
      OUTPUT(idDebugDrawing,                                                                                                                                                                               \
          bin,                                                                                                                                                                                             \
          (char)Drawings::arrow << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x1) << (int)(y1) << (int)(x2) << (int)(y2) << (char)(penWidth) << (char)(penStyle) << ColorRGBA(penColor)); \
    }                                                                                                                                                                                                      \
  while (false)
...
#define POSE_2D_SAMPLE(id, p, color)                                                                                                                      \
  do                                                                                                                                                      \
    ...
    {                                                                                                                                                     \
      Pose2f current = p;                                                                                                                                 \
      current += Pose2f(-100, 0);                                                                                                                         \
      LINE(id, int(current.translation.x()), int(current.translation.y()), int(p.translation.x()), int(p.translation.y()), 1, Drawings::solidPen, color); \
      current = p;                                                                                                                                        \
      current += Pose2f(-40, -40);                                                                                                                        \
      LINE(id, int(current.translation.x()), int(current.translation.y()), int(p.translation.x()), int(p.translation.y()), 1, Drawings::solidPen, color); \
      current = p;                                                                                                                                        \
      current += Pose2f(-40, 40);                                                                                                                         \
      LINE(id, int(current.translation.x()), int(current.translation.y()), int(p.translation.x()), int(p.translation.y()), 1, Drawings::solidPen, color); \
...
#define ORIGIN(id, x, y, angle)                                                                                                                            \
  do                                                                                                                                                       \
    DECLARED_DEBUG_RESPONSE("debug drawing:" id)                                                                                                           \
    {                                                                                                                                                      \
      OUTPUT(idDebugDrawing, bin, (char)Drawings::origin << (char)Global::getDrawingManager().getDrawingId(id) << (int)(x) << (int)(y) << (float)(angle)); \
    }                                                                                                                                                      \
  while (false)
...
#define DRAW_ROBOT_POSE(id, p, color)                                                                                         \
  do                                                                                                                          \
    ...
    {                                                                                                                         \
      ...
      dirVec += translation;                                                                                                  \
      LINE(id, translation.x(), translation.y(), dirVec.x(), dirVec.y(), 20, Drawings::solidPen, ColorRGBA::white);           \
      POLYGON(id, 4, bodyPoints, 20, Drawings::solidPen, ColorRGBA::black, Drawings::solidBrush, color);                      \
      CIRCLE(id, translation.x(), translation.y(), 42, 0, Drawings::solidPen, ColorRGBA::black, Drawings::solidBrush, color); \
    }                                                                                                                         \
  while (false)
  ...
  do                                                                                                                                                                                          \
    ...
    {                                                                                                                                                                                         \
      ...
      const float angle = 0.5f * std::atan2(2.0f * cov(1, 0), varianceDiff);                                                                                                                  \
                                                                                                                                                                                              \
      ELLIPSE(id, mean, std::sqrt(3.0f) * axis1, std::sqrt(3.0f) * axis2, angle, 10, Drawings::solidPen, ColorRGBA(100, 100, 255, 100), Drawings::solidBrush, ColorRGBA(100, 100, 255, 100)); \
      ELLIPSE(id, mean, std::sqrt(2.0f) * axis1, std::sqrt(2.0f) * axis2, angle, 10, Drawings::solidPen, ColorRGBA(150, 150, 100, 100), Drawings::solidBrush, ColorRGBA(150, 150, 100, 100)); \
      ELLIPSE(id, mean, axis1, axis2, angle, 10, Drawings::solidPen, ColorRGBA(255, 100, 100, 100), Drawings::solidBrush, ColorRGBA(255, 100, 100, 100));                                     \
    }                                                                                                                                                                                         \
  while (false)
 ...
 * @param id The name of the plot.
 */
#define DECLARE_PLOT(id) DECLARE_DEBUG_RESPONSE("plot:" id)
