...
FifthOrderPolynomial::FifthOrderPolynomial(const float x0, const float fx0, const float fx0d, const float fx0dd, const float x1, const float fx1, const float fx1d, const float fx1dd)
{
  ...
  Matrix6f A;
  A << 1, x0, x02, x03, x04, x05, 0, 1, 2 * x0, 3 * x02, 4 * x03, 5 * x04, 0, 0, 2, 6 * x0, 12 * x02, 20 * x03, 1, x1, x12, x13, x14, x15, 0, 1, 2 * x1, 3 * x12, 4 * x13, 5 * x14,
