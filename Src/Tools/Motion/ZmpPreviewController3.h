...
public:
   ...
   * @return
   */
  double step(const double currentZmp, const double currentCom, const std::deque<float>& zmpPreviews, const bool useFeedback, const Vector2f& feedbackFactor, const bool useFeedbackFactor);
   ...
   */
  void init(const double dt, const double comHeight, const unsigned numPreviews, const double R, const double Qx, const double Qe, const Vector3d& QlDiag, const Vector2d& R0Diag);
  ...
  Matrix3d dare2(const Matrix3d& A, const Matrix3x2d& B, const Matrix3d& Q, const Matrix2d& R);
