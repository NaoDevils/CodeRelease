...
public:
   ...
   */
  unsigned getRemoteTimeInLocalTime(unsigned remoteTime, unsigned char remoteId, unsigned localTime) const;
   ...
   * @return The time in local time
   */
  unsigned getRemoteTimeInLocalTime(unsigned remoteTime, unsigned localTime) const { return getRemoteTimeInLocalTime(remoteTime, currentRemoteId, localTime); }

  unsigned getRemoteTimeInLocalTime(unsigned remoteTime) const {return getRemoteTimeInLocalTime(remoteTime, currentRemoteId, SystemCall::getCurrentSystemTime());}
   ...
   * Added by NDevils.
  */
  void setCurrentRemoteID(unsigned int remoteIp);
};
