...
public:
   ...
   */
  bool error() const { return process->exitStatus() == QProcess::CrashExit || process->exitCode() != 0; }
...
public:
   ...
   */
  RemoteWriteProcessRunner(Context& context, const QString& program, const QStringList& arguments, const QByteArray& data);
};
