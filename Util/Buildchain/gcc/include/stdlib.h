...
/**
 * NDEVILS
 * In the regular stdlib.h posix_memalign would specify a throw()
 * unfortunately this conflics with the declaration of posix_memalign of clang.
 * The only option to make them compatible was either add "throw()" in clangs
 * declaration, or remove it here. Since we mainly use clang, we opted to
 * change it here, rather than in the clang headerfile.
 **/
