...
public:
   ...
   */
  template <typename V> static void convertMatrix(const dReal* mODE, Eigen::Matrix<V, 3, 3>& mSim)
  {
   ...
   */
  template <typename V> static void convertVector(const dReal* vODE, Eigen::Matrix<V, 3, 1>& vSim)
  {
   ...
   */
  template <typename V> static void convertVector(const dVector3& vODE, V* farray)
  {
